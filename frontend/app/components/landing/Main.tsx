			...
			<div className="relative z-10 flex flex-1 flex-col justify-center items-center px-4 py-12 sm:py-16">
				<div className="flex flex-col gap-8 items-center justify-center max-w-4xl mx-auto w-full">
					<div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
						<div className="relative w-36 h-50 sm:w-44 sm:h-44 rounded-2xl overflow-hidden shrink-0 ring-1 ring-zinc-700/50 shadow-xl">
							<Image
								src="/rosto.jpg"
								alt="Nicolas Nagano"
								fill
								...
								priority
								sizes="(max-width: 680px) 160px, 176px"
							/>
						</div>
